    ...
    >
      ...
      <div>
        <div className="h-16 px-4 flex items-center justify-between border-b border-slate-800/80">
          {!isCollapsed && (
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[10px] text-slate-400 font-mono uppercase tracking-wider leading-tight truncate">
                  Compliance Intel
                </div>
              </div>
            </div>
          ...
          {isCollapsed && (
            <div className="mx-auto h-8 w-8 rounded-lg bg-blue-600 flex items-center justify-center text-white shadow-xs">
              <Shield className="h-4 w-4" />
            </div>
          )}
