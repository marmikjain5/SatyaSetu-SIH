...
export const MOCK_RULES: RegulatoryRule[] = [
  ...
  // ─── Legal Metrology Amendment Rules, 2022 (Unit Sale Price) ───────────
  {
    id: 'RULE-LM-USP-001',
    code: 'LM-PCR-2022-R6-1AA',
    act: 'Legal Metrology (Packaged Commodities) Amendment Rules, 2022',
    title: 'Mandatory Declaration of Unit Sale Price (USP) per g/ml',
    description: 'Rule 6(1)(aa) [G.S.R. 779(E), eff. 1 Jan 2023] mandates declaration of Unit Sale Price in ₹ per g (if package net wt < 1kg) or ₹ per kg (if >= 1kg), and ₹ per ml / ₹ per L for liquids. Failure constitutes statutory non-declaration under Sec 36.',
    category: 'Price & Unit Declarations',
    severity: 'critical',
    isActive: true,
    minFine: 25000,
    maxFine: 100000,
  ...
  // ─── Legal Metrology Amendment Rules, 2017 (Country of Origin & Importer) 
  {
    id: 'RULE-LM-IMP-001',
    code: 'LM-PCR-2017-R6-1B',
    act: 'Legal Metrology (Packaged Commodities) Amendment Rules, 2017',
    title: 'Mandatory Country of Origin & Importer Address Declarations',
    description: 'Rule 6(1)(b) [G.S.R. 629(E)] requires every pre-packaged imported commodity to prominently declare the Country of Origin and complete Indian premises address of the importer on the Principal Display Panel.',
    category: 'Origin & Importer Compliance',
    severity: 'high',
    isActive: true,
    minFine: 25000,
    maxFine: 50000,
