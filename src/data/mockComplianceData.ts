...
export const INSPECTOR_PERFORMANCE_METRICS: InspectorPerformanceMetric[] = [
  {
    id: 'insp-101',
    name: 'Inspector Arjun Nair',
    badgeId: 'LM-INSP-BLR-001',
    assignedZone: 'Bengaluru South-East (HSR/Koramangala)',
    fieldScansConducted: 1240,
    inspectionsCompleted: 48,
    scnIssued: 18,
    penaltiesRecommended: 1240000,
    averageSlaDays: 3.2,
  ...
  },
  {
    ...
    badgeId: 'LM-INSP-BLR-002',
    assignedZone: 'Bengaluru Central (MG Road & Commercial)',
    fieldScansConducted: 980,
    inspectionsCompleted: 36,
    scnIssued: 14,
    penaltiesRecommended: 980000,
    averageSlaDays: 4.1,
    complianceRating: 95.8,
    status: 'Highly Vigilant',
  },
  {
    id: 'insp-103',
    name: 'Inspector Rajesh Verma',
    badgeId: 'LM-INSP-BLR-003',
    assignedZone: 'Peenya Industrial Estate & Dasarahalli',
    fieldScansConducted: 1410,
    inspectionsCompleted: 52,
    scnIssued: 22,
    penaltiesRecommended: 1850000,
    averageSlaDays: 3.8,
    complianceRating: 97.1,
    status: 'Top Performer',
  },
  {
    id: 'insp-104',
    name: 'Inspector Anand Kulkarni',
    badgeId: 'LM-INSP-BLR-004',
    assignedZone: 'Electronic City Phase 1 & 2 Hubs',
    fieldScansConducted: 850,
    inspectionsCompleted: 29,
    scnIssued: 11,
    penaltiesRecommended: 720000,
    averageSlaDays: 4.8,
    complianceRating: 92.5,
    status: 'Active',
  },
  {
    id: 'insp-105',
    name: 'Inspector Meera Reddy',
    badgeId: 'LM-INSP-BLR-005',
    assignedZone: 'Whitefield & Hoodi Tech Cluster',
    fieldScansConducted: 1120,
    inspectionsCompleted: 41,
    scnIssued: 16,
    penaltiesRecommended: 1130000,
    averageSlaDays: 3.5,
