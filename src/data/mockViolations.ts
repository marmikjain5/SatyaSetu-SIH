...
export const MOCK_VIOLATIONS: Violation[] = [
  ...
  // 7. Himalaya — Liv.52 claim dispute (Karnataka HC, 2023)
  {
    id: 'VIO-REAL-007',
    caseNumber: 'WP 25341/2023 – Karnataka High Court',
    productId: 'PRD-HIM-007',
    productName: 'Liv.52 DS Tablets (60 tab, 120 tab packs)',
    brand: 'Himalaya',
    marketedBy: 'Himalaya Drug Company Private Limited',
    manufacturer: 'Himalaya Drug Company Private Limited',
    platform: 'Pan-India Retail & Pharmacy',
    ruleCode: 'CCPA-ADV-GUID-2022-G7',
    actName: 'CCPA Guidelines for Prevention of Misleading Advertisements, 2022',
    section: 'Guideline 7 — Scientific Substantiation Requirement for Health Claims',
    description:
      '"Clinically proven hepatoprotective" and "Scientifically validated" claims on labelling challenged by a hepatologist (2023). Karnataka HC allowed reactivation of critic\'s account. CCPA 2022 guidelines require a pre-publication substantiation certificate for health claims; no such certificate on file.',
    severity: 'medium',
    status: 'Resolved',
    detectedAt: '2023-09-18 IST',
    evidence: {
      type: 'Regulatory Advisory + Court Record',
      extractedValue: '"Clinically proven hepatoprotective" claim — no CCPA-recognised substantiation dossier on record per SC June 2024 directive',
      expectedStandard: 'CCPA 2022 Guideline 7: health/therapeutic claims require pre-publication scientific substantiation certificate',
    },
    penaltyEstimate: 10000,
    assignedOfficer: 'Arjun Nair (Sr. LM Inspector, Bengaluru City Circle)',
    noticeId: 'CCPA-ADV-KA-2023-HIM-001',
  },
];
