...
export const TRANSLATIONS: Record<SupportedLanguage, Translations> = {
  en: {
    ...
    descriptionPlaceholder: 'Describe what happened in detail (e.g. MRP on packet is ₹1999 but store charged ₹2499, or net weight is missing from label).',
  ...
  hi: {
    ...
    descriptionPlaceholder: 'विस्तार से लिखें कि क्या समस्या है (जैसे: पैकेट पर MRP ₹1,999 लिखा है लेकिन दुकानदार ने बिल में ₹2,499 लिया, या MRP नहीं लिखा है)।',
